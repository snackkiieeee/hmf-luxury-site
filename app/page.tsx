  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "41b6096a-a31e-49b4-92e5-5ad5844a93e5", // <-- PUT KEY HERE
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] text-gray-800 font-sans relative scroll-smooth">
      ...
      <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-1 hidden md:flex">
        <a href="#contact" className="bg-[#2A2A2A] text-white p-3 rounded-l-md flex items-center gap-2 cursor-pointer hover:bg-black transition-colors" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
      ...
      <nav className="bg-white sticky top-0 z-40 shadow-sm py-3 px-6 flex justify-between items-center h-20">
        ...
        <div className="hidden md:flex gap-8 font-medium text-gray-700 uppercase text-sm tracking-wide">
          ...
          <a href="#contact" className="hover:text-[#A6937B] transition-colors">Contact Us</a>
        </div>
      </nav>

      {/* Hero Section with Overlapping Form */}
      <section className="relative bg-[url('/hero-bg.png')] bg-cover bg-center h-[600px] md:h-[700px]">
        {/* Soft overlay so the form stands out, but keeps the bright image visible */}
        <div className="absolute inset-0 bg-black/20 md:bg-gradient-to-r md:from-transparent md:to-black/40"></div>
        
        <div className="container mx-auto px-6 h-full relative z-10 flex flex-col justify-center items-end">
          
          {/* Lead Generation Form */}
          <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md mt-10 md:mt-0 border-t-4 border-[#A6937B]">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <a href="#contact" className="inline-block mt-8 border-2 border-[#2A2A2A] text-[#2A2A2A] px-8 py-3 font-bold uppercase tracking-widest text-sm hover:bg-[#2A2A2A] hover:text-white transition-colors rounded">
            ...
            {IG_LINKS.map((link, index) => (
              <a href={link} target="_blank" rel="noreferrer" key={index} className="border border-gray-200 rounded-lg overflow-hidden relative group block hover:shadow-xl transition-all duration-300">
                <div className="bg-[#2A2A2A] h-72 relative flex items-center justify-center overflow-hidden">
                  ...
                  {/* Thumbnail Placeholder - Can replace src with real reel thumbnails later */}
      ...
      <section className="py-20 bg-[#F9F9F9] border-t border-gray-200 text-center">
        <h2 className="text-3xl text-[#2A2A2A] font-serif">Get a free quote for your project. <a href="#contact" className="text-[#A6937B] hover:underline font-bold">Click here.</a></h2>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li><a href="#contact" className="flex items-center gap-2 hover:text-[#A6937B] hover:translate-x-1 transition-all"><ChevronRight size={14}/> Contact Us</a></li>
